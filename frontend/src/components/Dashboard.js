                ...
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="text-muted font-size-sm">DAIICT, Gandhinagar, Gujarat</p>
              ...
              <div className="card mt-3">
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">https://daiict.ac.in</span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">https://github.com/vihar-202001110/IT314_project_Grp08.git</span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">@toto</span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">daiict</span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div className="row gutters-sm">
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                    <button type="button" className="btn btn-dark my-1">Upload Recipe</button>
                    <button type="button" className="btn btn-dark my-1">View your Recipe</button>
                  </div>
                </div>
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                  <button type="button" className="btn btn-dark my-1">Watch History</button>
                  <button type="button" className="btn btn-dark my-1">Clear Watch History</button>
                  </div>
                </div>
              </div>
