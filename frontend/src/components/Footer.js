            ...
            <div className="container">
                <div className="row d-flex justify-content-between">
                    <div className="col-sm-12 col-md-6">
                        <h6>About</h6>
                        <p className="text-justify"><b>NAIVE BAKER</b> is an platorm to make cooking easy and joyful. This attracts the newbies to the webiste and experience cooking. The platform provides various filters to list our recipes based on the user demand. The platfrom is a free to use platform. </p>
                        <p className="text-justify">We are proud to announce that we are planning to extend this services on mobile apps. </p>
                        <p className="text-justify">ENJOY COOKING </p>
                    </div>
